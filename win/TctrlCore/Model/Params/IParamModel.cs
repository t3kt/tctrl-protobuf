...
namespace Tctrl.Core.Model.Params {
    ...
    public interface IScalarParamModel<TValue> : ISingleParamModel where TValue : struct {
        TValue? Value { get; }
    ...
    public interface INumericParamModel<TValue> : IScalarParamModel<TValue>, INumericParamModel where TValue : struct, IComparable<TValue> {
